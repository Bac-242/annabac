...
\newcommand{\exo}[2]{\bigskip\noindent{\large\bfseries\color{bacnuit} Exercice #1}\hfill\textit{#2}\par\nopagebreak\smallskip}
...
\setlist[questions]{label=\textbf{\arabic*.},leftmargin=1.8em,itemsep=4.5pt,topsep=6pt}
\newlist{sousq}{enumerate}{1}
\setlist[sousq]{label=\textbf{\alph*.},leftmargin=1.8em,itemsep=3.5pt,topsep=4pt}
