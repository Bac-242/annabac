...
\entetecorrige{2019}{D}{Physique-Chimie}
...
\begin{methode}
Déterminer un ordre de réaction à partir de mesures $(v, [A])$ :
écrire $v = k[A]^n$ pour deux mesures et faire le \emph{quotient} — $k$
s'élimine et $n = \dfrac{\ln(v_2/v_1)}{\ln([A]_2/[A]_1)}$. Vérifier
avec une troisième mesure, puis en déduire $k$, dont l'unité dépend de
l'ordre.
\end{methode}
...
\begin{rappel}
Le temps de demi-réaction dépend de l'ordre : pour l'ordre 1,
$t_{1/2} = \frac{\ln 2}{k}$ est \emph{indépendant} de la concentration
initiale (cas de la radioactivité) ; pour l'ordre 2, $t_{1/2}$ est
inversement proportionnel à $[A]_0$ — c'est même un test expérimental
pour distinguer les deux ordres.
\end{rappel}
...
\begin{methode}
Dynamique dans un ascenseur : établir d'abord la relation générale par
le TCI (ici $L = \frac{m}{k}(g + a) + L_0$), puis calculer $a$ phase
par phase avec la cinématique — $v^2 - v_0^2 = 2a\,\Delta x$ si l'on
connaît la distance, $a = \frac{\Delta v}{\Delta t}$ si l'on connaît la
durée — en respectant le \emph{signe} de $a$ (négatif en freinage).
\end{methode}
